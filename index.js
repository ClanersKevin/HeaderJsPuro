const headerContainerBanner = document.querySelector('#headerContainerBanner').getAttribute('data-store');
...
Object.keys(data).map(function (key) {
    if (key === headerContainerBanner)
    {
        const bannerSite = document.getElementById("bannerSite");
        bannerSite.innerHTML = data[key].title;
        bannerSite.style.background = data[key].background;
        bannerSite.style.color = data[key].color;
